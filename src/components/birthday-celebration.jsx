  ...
  return (
    <div className="flex flex-col items-center">
      ...
      >
        ...
        <h3 className="text-2xl sm:text-3xl font-bold text-center text-pink-600 mt-2">To Anjali baba💖</h3>
      </motion.div>
          ...
          <AnimatePresence>
            ...
            >
              <div className="text-center">
                ...
                Once we were strangers but now the journey is going beyond friendship🥹. I would like to be beside you as a friend for every problem you face☺️🐣.
                </p>
      ...
      >
        <div className="text-center">
          ...
          <p className="text-blue-600 font-medium">Once again Happy Birthday Khushi jii......🥰 </p> 
          
          <div className="flex justify-center items-center gap-2">
            <p className="text-pink-600 font-medium">Let’s always stay like this... together, forever <br></br>as bestfriends🫶</p>
          </div>
        </div>
      </motion.div>
    </div>
